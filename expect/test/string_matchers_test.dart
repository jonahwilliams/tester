...
testReportsMismatchesInWhitespaceAndEscapeSequences() {
  shouldFail('before\nafter', equals('before\\nafter'),
      contains('Differ at offset 7'));
}

testRetainsOuterMatcherMismatchText() {
  shouldFail(
      {'word': 'thing'},
...
testIsNotIsEmpty() {
  ...
  shouldFail(
      null, isNot(isEmpty), startsWith('Expected: not empty  Actual: <null>'));
}
...
testContains() {
  ...
  shouldFail('hello', contains(' '), "Expected: contains ' ' Actual: 'hello'");
}
